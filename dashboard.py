...
# --- LEGENDS AI V13.2 CORE (MİMAR KORUMASI) ---
API_KEYS = [
...
SYSTEM_PROMPT = "Sen Legends AI'sın. Şenol Kocabıyık'ın baş mimarısın. 1) Sadece tam kod yaz. 2) Özellikleri asla silme. 3) Tasarımları efsanevi neon yap."

@app.route('/manifest.json')
def manifest():
    return jsonify({"name": "Legends AI | Architect","short_name": "LegendsAI","start_url": "/","display": "standalone","background_color": "#020617","theme_color": "#f97316"})
...
<body>
    ...
    <script type="module">
        ...
        const firebaseConfig = { apiKey: "AIzaSyAnNzL2wSLEsy6DprleCNSq9elnv3X7BTg", authDomain: "legendsai-3e2d6.firebaseapp.com", projectId: "legendsai-3e2d6", storageBucket: "legendsai-3e2d6.firebasestorage.app", messagingSenderId: "504400540515", appId: "1:504400540515:web:16cdc9ff57dd8fa2981956" };
        ...
        document.getElementById('applyChangesBtn').onclick = async () => {
            ...
            if(data.success) { document.getElementById('archStatus').innerText = "✅ TASARIM UYGULANDI! Yenileniyor..."; setTimeout(() => window.location.reload(), 2000); } else { alert("Hata: " + data.error); }
        };
        ...
        function addUI(t, r) {
            ...
            if(r==='ai') { d.querySelectorAll('pre').forEach(pre => { const b=document.createElement('button'); b.className='code-btn'; b.innerHTML='<i class="fas fa-copy"></i> Kopyala'; b.onclick=()=>navigator.clipboard.writeText(pre.innerText); pre.appendChild(b); }); }
